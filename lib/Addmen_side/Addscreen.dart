            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  buildTextField(
                      controller: txtCate, hint: "category"),
                  const SizedBox(
                    height: 20,
                  ),
                  buildTextField(
                      controller: txtdescount, hint: "desc"),
                  const SizedBox(
                    height: 20,
                  ),
                  ...
                  buildTextField(
                      controller: txtDesc, hint: "description"),
                  const SizedBox(
                    height: 25,
                  ),
                  InkWell(
                    onTap: () {
                      Model_ecommerce model = Model_ecommerce(
                          ...
                          Price: txtPrice.text);
                      FirebaseHelper.firehelper.inserData(model);
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          "Add",
                          style:
                          GoogleFonts.alef(color: Colors.white),
                        ),
                      ),
                    ),
                  ),
